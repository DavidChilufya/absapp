  ...
  List getSections() {
    return [  
        ...
        },
        {
          ...
          'sec':'sec_21',
          'status':this.variables['active'], //means section is active
          'title': '21. Concentrates bought during previous year(i.e since May ${this.variables['year']})',
          'no' : '21',
          '_1': ['Have you made any home-made concentrates in the last year',[true], ['Yes','No']],
          ...
          '_3': ['C. What do you use to clean your cans?',[true], ['Cold water','Warm water','Boiling water','Detergent','Other']],
        ...
        },
        {
        ...
        },
         {
          ...
          'no' : '32',
          '_1': ['Who do you normally call if one of your cows needs veterinary treatment',[true],
                ['Government vet','Private vet','CAHW','AI technician','Other',],
                          ['If using a government vet how do you purchase any drugs required?',
                          ['Select','Government vet tells me what to buy and I buy it myself',
                            'I buy the medicines from the government vet',
                            'It depends – sometimes I buy myself and sometimes from the government vet']]], 
          ...
          '_2': ['B. If yes, What advice or assitance did you receive?',[true],[
                {'topic':'Fodder Crop production ','organisation':['ZDTP','MFL','Heifer','DAZ','Parmalat / Lactalis','Zammilk','Dairy Gold','Other']},
                {'topic':'Cattle nutrition ','organisation':['ZDTP','MFL','Heifer','DAZ','Parmalat / Lactalis','Zammilk','Dairy Gold','Other']},
                {'topic':'Milk hygiense ','organisation':['ZDTP','MFL','Heifer','DAZ','Parmalat / Lactalis','Zammilk','Dairy Gold','Other']},
                {'topic':'Animal health, Management, Husbandry ','organisation':['ZDTP','MFL','Heifer','DAZ','Parmalat / Lactalis','Zammilk','Dairy Gold','Other']},
                {'topic':'Farm record keeping ','organisation':['ZDTP','MFL','Heifer','DAZ','Parmalat / Lactalis','Zammilk','Dairy Gold','Other']},
                {'topic':'Cattle breeding/ reproduction ','organisation':['ZDTP','MFL','Heifer','DAZ','Parmalat / Lactalis','Zammilk','Dairy Gold','Other']},
                {'topic':'Accounting/Financial /business management ','organisation':['ZDTP','MFL','Heifer','DAZ','Parmalat / Lactalis','Zammilk','Dairy Gold','Other']},
                {'topic':'Other ','organisation':['ZDTP','MFL','Heifer','DAZ','Parmalat / Lactalis','Zammilk','Dairy Gold','Other']},
          ]], 
