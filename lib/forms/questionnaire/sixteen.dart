...
class _SixteenState extends State<Sixteen> {
  ...
  List _questionnaireList,
      _numberInputControllersList,
      _commentInputControllersList;
                    ...
                    Form(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                                ...
                                (int index) {
                                  return ChoiceChip(
                                    ...
                                    onSelected: (bool selected) {
                                      ...
                                      if(_1input_answer == 'No') {
                                        _1Controller..text = '0';
                                      }else if(_1input_answer == 'Yes'){
                                        _1Controller.clear();
                                      }
                                    },
                                  );
                                  ...
                                  return ChoiceChip(
                                    ...
                                    onSelected: (bool selected) {
                                      setState(() {
                                       ...
                                       if(_3input_answer == 'No') {
                                        _15Controller..text = '0';
                                      }else if(_3input_answer == 'Yes'){
                                        _15Controller.clear();
                                      }
                                    },
                                  );
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: List.generate(_questionnaireList.length,
                                  (int index) {
                                return index == 0 && _1input_answer == 'No' || index == 14 && _3input_answer == 'No' ?
                                Container():
                                Column(
                                    crossAxisAlignment:
                                    ...
                                    children: <Widget>[
                                        ...
                                        children: List<Widget>.generate(
                                          ...
                                          (int index2) {
                                            return ChoiceChip(
                                              ...
                                              label: Text(
                                                  _questionnaireList[index][2]
                                                      [index2]),
                                              selected:
                                                  _conditionIndexList[index] ==
                                                      index2,
                                              onSelected: (bool selected) {
                                                setState(() {
                                                  _conditionAnswerList[index] =
                                                      _questionnaireList[index]
                                                          [2][index2];
                                                  _conditionIndexList[index] =
                                                      selected ? index2 : null;
                                      ...
                                      TextFormField(
                                        controller:
                                            _commentInputControllersList[index],
  ...
  void _submitForm(Interview states) async {
    ...
    if (_formKey.currentState.validate()) {
      ...
      Map data = {
        ...
        '_1': {
          '_number': _1Controller.text,
          '_condition': [_conditionAnswerList[0], _conditionIndexList[0]],
          '_comment': _1_2Controller.text
        },
        '_2': {
          '_number': _2Controller.text,
          '_condition': [_conditionAnswerList[1], _conditionIndexList[1]],
          '_comment': _2_2Controller.text
        },
        '_3': {
          '_number': _3Controller.text,
          '_condition': [_conditionAnswerList[2], _conditionIndexList[2]],
          '_comment': _3_2Controller.text
        },
        '_4': {
          '_number': _4Controller.text,
          '_condition': [_conditionAnswerList[3], _conditionIndexList[3]],
          '_comment': _4_2Controller.text
        },
        '_5': {
          '_number': _5Controller.text,
          '_condition': [_conditionAnswerList[4], _conditionIndexList[4]],
          '_comment': _5_2Controller.text
        },
        '_6': {
          '_number': _6Controller.text,
          '_condition': [_conditionAnswerList[5], _conditionIndexList[5]],
          '_comment': _6_2Controller.text
        },
        '_7': {
          '_number': _7Controller.text,
          '_condition': [_conditionAnswerList[6], _conditionIndexList[6]],
          '_comment': _7_2Controller.text
        },
        '_8': {
          '_number': _8Controller.text,
          '_condition': [_conditionAnswerList[7], _conditionIndexList[7]],
          '_comment': _8_2Controller.text
        },
        '_9': {
          '_number': _9Controller.text,
          '_condition': [_conditionAnswerList[8], _conditionIndexList[8]],
          '_comment': _9_2Controller.text
        },
        '_10': {
          '_number': _10Controller.text,
          '_condition': [_conditionAnswerList[9], _conditionIndexList[9]],
          '_comment': _10_2Controller.text
        },
        '_11': {
          '_number': _11Controller.text,
          '_condition': [_conditionAnswerList[10], _conditionIndexList[10]],
          '_comment': _11_2Controller.text
        },
        '_12': {
          '_number': _12Controller.text,
          '_condition': [_conditionAnswerList[11], _conditionIndexList[11]],
          '_comment': _12_2Controller.text
        },
        '_13': {
          '_number': _1Controller.text,
          '_condition': [_conditionAnswerList[12], _conditionIndexList[12]],
          '_comment': _13_2Controller.text
        },
        '_14': {
          '_number': _14Controller.text,
          '_condition': [_conditionAnswerList[13], _conditionIndexList[13]],
          '_comment': _14_2Controller.text
        },
        '_15': {
          '_number': _15Controller.text,
          '_condition': [_conditionAnswerList[14], _conditionIndexList[14]],
          '_comment': _15_2Controller.text
        },
        '_16': {
          '_number': _16Controller.text,
          '_condition': [_conditionAnswerList[15], _conditionIndexList[15]],
          '_comment': _16_2Controller.text
        },
      };
